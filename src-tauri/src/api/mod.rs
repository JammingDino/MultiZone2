...
fn build_router(state: ApiState) -> Router {
    ...
    let protected = Router::new()
        ...
        .route("/api/mcp/servers/:id/resources", get(h::list_mcp_resources))
        .route("/api/mcp/servers/:id/resources/read", post(h::read_mcp_resource))
        .route("/api/mcp/servers/:id/prompts", get(h::list_mcp_prompts))
        .route("/api/mcp/servers/:id/prompts/get", post(h::get_mcp_prompt))
